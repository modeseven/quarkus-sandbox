...
/**
 * Test implementation of FieldHydrationService that uses in-memory cache.
 * This is used for testing to avoid Redis dependency.
 */
@ApplicationScoped
@Alternative
public class TestFieldHydrationService {

    private static final Logger LOG = Logger.getLogger(TestFieldHydrationService.class);
